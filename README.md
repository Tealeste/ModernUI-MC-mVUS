...
- 输出位置（可直接用于发布）：`build/release/ModernUI-MC-<mod_version>-{fabric,forge,neoforge}.jar`（例如：`build/release/ModernUI-MC-3.12.0.5-build.2+mc1.21.11-{fabric,forge,neoforge}.jar`）
- 运行开发客户端：
