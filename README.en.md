...
- Output jars (ready for distribution): `build/release/ModernUI-MC-<mod_version>-{fabric,forge,neoforge}.jar` (e.g. `build/release/ModernUI-MC-3.12.0.5-build.2+mc1.21.11-{fabric,forge,neoforge}.jar`)
- Run a dev client:
